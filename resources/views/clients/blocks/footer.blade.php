                    ...
                    <div class="row">
                       <div class="col-lg-5">
                            <div class="copyright-text text-center text-lg-start">
                                <p>@Copy 2024 <a href="{{ route('home') }}">Travella</a>, All rights reserved</p>
                            </div>
                       </div>
...
<!-- Mirrored from webtendtheme.net/html/2024/Travella/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 09:27:04 GMT -->
</html>