            ...
            <div class="col-lg-4">
                <div class="contact-info-content mb-30 rmb-55" data-aos="fade-up" data-aos-duration="1500"
                    ...
                    <div class="section-title mb-30">
                        <h2>Hãy trò chuyện với các hướng dẫn viên du lịch chuyên gia của chúng tôi</h2>
                    </div>
                    <p>Đội ngũ hỗ trợ tận tâm của chúng tôi luôn sẵn sàng hỗ trợ bạn với bất kỳ câu hỏi hoặc vấn đề nào, cung cấp các giải pháp nhanh chóng và cá nhân hóa để đáp ứng nhu cầu của bạn.</p>
                        ...
                        <div class="row mt-35">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="message" id="message" class="form-control" rows="5" placeholder="Tin nhắn" required
                                        data-error="Vui lòng nhập tin nhắn của bạn"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<div class="contact-map">
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d96777.16150026117!2d-74.00840582560909!3d40.71171357405996!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2sbd!4v1706508986625!5m2!1svi!2sbd"
