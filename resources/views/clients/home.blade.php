        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up"
                    ...
                    <h2>Discover the World's Treasures with Travella</h2>
                    <p>One site <span class="count-text plus" data-speed="3000" data-stop="45600">0</span> most popular
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section-title text-center counter-text-wrap mb-70" data-aos="fade-up"
                        ...
                        <p>One site <span class="count-text plus" data-speed="3000" data-stop="45600">0</span> most
                    ...
                    <div class="col-md-6">
                        <div class="destination-item style-two" data-aos="flip-up" data-aos-duration="1500"
                            ...
                            <div class="content">
                                ...
                                <span class="time">9999+ tours & 999+ Activity</span>
                                <a href="#" class="more"><i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="blog-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="content">
                        ...
                        <h5><a href="blog-details.html">Ultimate Guide to Planning Your Dream Vacation with Travella
                                Travel Agency</a></h5>
                        <ul class="blog-meta">
